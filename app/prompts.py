...
The Title MUST be copied exactly from the "--- Document: Title ---" header in the context — \
do not paraphrase, invent, or substitute your own label. Cite each source at least once where \
you use it; do not cite documents you did not use. Only fall back to general HPC knowledge \
when the provided context is silent on the topic, and do not add a citation in that case.
